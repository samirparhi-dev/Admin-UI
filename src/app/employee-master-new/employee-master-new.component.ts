  ...
  createUser() {
    ...
    for (var i = 0; i < this.objs.length; i++) {
      ...
      var tempObj = {
        ...
        'addressLine1': (this.objs[i].currentAddressLine1 !== undefined && this.objs[i].currentAddressLine1 !== null) ? this.objs[i].currentAddressLine1.trim() : null,
        'addressLine2': (this.objs[i].currentAddressLine2 !== undefined && this.objs[i].currentAddressLine2 !== null) ? this.objs[i].currentAddressLine2.trim()  : null,
        'stateID': this.objs[i].currentState,
        'districtID': this.objs[i].currentDistrict,
        'pinCode': this.objs[i].currentPincode,
        'permAddressLine1': (this.objs[i].permanentAddressLine1 !== undefined && this.objs[i].permanentAddressLine1 !== null) ? this.objs[i].permanentAddressLine1.trim() : null,
        'permAddressLine2': (this.objs[i].permanentAddressLine2 !== undefined && this.objs[i].permanentAddressLine2 !== null) ? this.objs[i].permanentAddressLine2.trim() : null,
