...
*/
  ...
  update(userCreationFormValue, demographicsValue, communicationFormValue) {
    let update_tempObj = {
      ...
      'addressLine1': communicationFormValue.current_addressLine1,
      'addressLine2': communicationFormValue.current_addressLine2,
      'stateID': communicationFormValue.current_state,
      'districtID': communicationFormValue.current_district,
      'pinCode': communicationFormValue.current_pincode,
      'userID': this.userId,
