...
export class SuperAdmin_ServiceProvider_Service {
  ...
  constructor(private _http: Http, public ConfigService: ConfigService, private _httpInterceptor: InterceptedHttp) {
  ...
  public createServiceProvider = function (serviceProviderRequestObject) {
    ...
    return this._httpInterceptor.post(this.service_provider_setup_url, serviceProviderRequestObject)
